...
class Book(models.Model):
    code_no = models.CharField(max_length=50, unique=True)  # unique code like SC(B/M)000001
...
class Transaction(models.Model):
    ...
    due_date = models.DateField()                 # set on creation/issue
    ...
    def calculate_fine(self, per_day=Decimal('5.00')):
        """Compute fine based on return_date and due_date. Does not save."""
